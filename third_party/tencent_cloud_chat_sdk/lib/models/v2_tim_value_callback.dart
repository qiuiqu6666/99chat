  ...
  V2TimValueCallback.fromJson(Map json) {
    ...
    if (json['json_param'] == null) {
      ...
      if (result.isNotEmpty && T != String) {
        ...
        } else if (T == _getT<Map<String, dynamic>>()) {
          fromJsonData = Map<String, dynamic>.from(jsonParam) as T;
        } else if (T == _getT<List<Map<String, dynamic>>>()) {
          fromJsonData = List.from(jsonParam).map((e) => Map<String, dynamic>.from(e)).toList() as T;
        } else {
