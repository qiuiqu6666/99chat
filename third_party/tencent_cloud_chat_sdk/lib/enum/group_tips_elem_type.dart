...
class GroupTipsElemType {
  ...
  ///
  static const int V2TIM_GROUP_TIPS_TYPE_TOPIC_INFO_CHANGE = 9;

  ///置顶群消息
  ///
  static const int V2TIM_GROUP_TIPS_TYPE_PINNED_MESSAGE_ADDED = 10;

  ///取消置顶群消息
  ///
  static const int V2TIM_GROUP_TIPS_TYPE_PINNED_MESSAGE_DELETED = 11;
}
