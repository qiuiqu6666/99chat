...
public class TUICallKitPlugin implements FlutterPlugin, ITUINotification, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        CallPictureInPictureHelper.setForegroundNotifier(mCallKitManager::appEnterForeground);
    ...
    private void registerObserver() {
        ...
        TUICore.registerEvent(Constants.KEY_CALLKIT_PLUGIN, Constants.SUB_KEY_EVENT_WAKEUP, this);
        TUICore.registerEvent(Constants.KEY_CALLKIT_PLUGIN, Constants.SUB_KEY_NOTIFICATION_CALL_ACTION, this);
    }
    ...
    public void onNotifyEvent(String key, String subKey, Map<String, Object> params) {
        ...
        if (Constants.SUB_KEY_NOTIFICATION_CALL_ACTION.equals(subKey)) {
            mCallKitManager.handleNotificationCallAction(params);
            return;
        }
        ...
        if (Constants.SUB_KEY_EVENT_WAKEUP.equals(subKey)) {
            mCallKitManager.countWakeUV();
        }
    }
    ...
    public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
        ...
        CallPictureInPictureHelper.setActivity(binding.getActivity());
    }

    @Override
    public void onDetachedFromActivityForConfigChanges() {
        WakeLock.getInstance().setActivity(null);
        CallPictureInPictureHelper.clearActivity(null);
    }
