...
public class IncomingFloatView {
    ...
    private void initWindow() {
        ...
        imageReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cancelIncomingView();
                notifyFlutterAction(context, "reject");
            }
        });
        ...
        imageAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cancelIncomingView();
                WindowManager.launchMainActivity(context);
                notifyFlutterAction(context, "accept");
            }
        });
    ...
    private void notifyFlutterAction(Context context, String action) {
        String callId = IncomingNotificationView.getInstance(context).getActiveCallId();
