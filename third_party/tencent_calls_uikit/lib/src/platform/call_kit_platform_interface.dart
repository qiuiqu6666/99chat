...
import 'package:tencent_calls_uikit/src/platform/call_kit_platform_stub.dart'
    if (dart.library.io) 'package:tencent_calls_uikit/src/platform/call_kit_method_channel.dart';
...
abstract class TUICallKitPlatform extends PlatformInterface {
  ...
  Future<bool> isAndroidPictureInPictureSupported() async {
    return await instance.isAndroidPictureInPictureSupported();
  }

  Future<void> enterMobilePictureInPicture() async {
    await instance.enterMobilePictureInPicture();
  }
  ...
  Future<bool> isNotificationEnabled() async {
    return await instance.isNotificationEnabled();
  }
  ...
  Future<void> setScreenPowerPolicy(CallScreenPowerPolicy policy) async {
    await instance.setScreenPowerPolicy(policy);
  }
