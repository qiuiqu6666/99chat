...
import 'package:tencent_calls_uikit/src/utils/immersive_system_ui.dart';
...
class _TUICallKitWidgetState extends State<TUICallKitWidget> with WidgetsBindingObserver {
  ...
  void initState() {
    super.initState();
    CallImmersiveSystemUi.apply();
    TRTCLogger.info('TUICallKitWidget initState');
    KeyMetrics.countUV(EventId.wakeup);
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: CallImmersiveSystemUi.overlayStyle,
      child: WillPopScope(
        onWillPop: () async {
          return false;
        },
  ...
  @override
  void dispose() {
    CallImmersiveSystemUi.restoreAfterCall();
    super.dispose();
