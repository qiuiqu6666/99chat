class Constants {
  static const String pluginVersion = '3.6.1';
  ...
  static const List aiTranslationRobotPrefixList = [
    "TAI_Robot",
    "TAITranslation_Robot"
  ];
}
...
const setStateEventOnCallSignalingReady =
    'SET_STATE_EVENT_ONCALLSIGNALINGREADY';
