      ...
      decoration: BoxDecoration(
        ...
        border: Border(
            bottom: BorderSide(
                ...
                width: DirectoryListStyle.dividerThickness)),
      ),
      child: Row(
        ...
        children: [
          ...
          if (currentStatus == ApplicationStatus.none &&
            ...
            Padding(
              ...
              child: DirectoryActionButton(
                label: TIM_t("同意"),
                primaryColor: theme.primaryColor ?? const Color(0xFF1E90FF),
                onPressed: () async {
          ...
          if (currentStatus == ApplicationStatus.accept ||
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8),
              child: DirectoryStatusBadge(
                label: TIM_t("已同意"),
                textColor: theme.weakTextColor ?? CommonColor.weakTextColor,
                backgroundColor:
