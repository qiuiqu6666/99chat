...
class TIMUIKitProfileWidget extends TIMUIKitClass {
  ...
  static Widget remarkBar(BuildContext context, String remark, Function({Offset? offset, String? initText})? handleTap,
    ...
    return InkWell(
      ...
      child: TIMUIKitOperationItem(
        ...
        wideEditText: tr.k_0p3espj,
        operationName: tr.k_03exjk7,
  ...
  static Widget searchBar(
    ...
    return InkWell(
      ...
      child: TIMUIKitOperationItem(
        isEmpty: true,
        wideEditText: tr.k_118sw9v,
        operationName: tr.k_1uaov41,
      ),
    );
  }
  ...
  /// gender
  static Widget genderBar(BuildContext context, int gender, bool smallCardMode) {
    final tr = Translations.of(context);
    final genderMap = {
      0: UikitAppStrings.genderPrivate(),
      1: tr.k_0003v6a,
      2: tr.k_00043x2,
    };
    return SizedBox(
      child: TIMUIKitOperationItem(
        ...
        isEmpty: false,
        showAllowEditStatus: false,
        operationName: tr.k_003qgkp,
        operationRightWidget: Text(
            genderMap[gender] ?? UikitAppStrings.genderPrivate(),
  ...
  /// gender
  static Widget genderBarWithArrow(BuildContext context, int gender, bool smallCardMode) {
    final tr = Translations.of(context);
    final genderMap = {
      0: UikitAppStrings.genderPrivate(),
      1: tr.k_0003v6a,
