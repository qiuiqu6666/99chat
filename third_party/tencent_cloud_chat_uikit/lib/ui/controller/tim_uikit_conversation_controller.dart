...
class TIMUIKitConversationController {
  TUIConversationViewModel? _model;

  TUIConversationViewModel get model {
    _model ??= serviceLocator<TUIConversationViewModel>();
    return _model!;
  }

  set model(TUIConversationViewModel value) {
    _model = value;
  }
  ...
  reloadData({int count = 40, bool force = false}) {
    model.refresh(count: count, force: force);
  }
