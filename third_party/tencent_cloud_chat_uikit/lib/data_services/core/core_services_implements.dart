...
class CoreServicesImpl implements CoreServices {
  ...
  // Chat rows can be built from the persisted local snapshot before the
  // asynchronous UIKit login bootstrap has populated these values. Keep the
  // public loginInfo snapshot safe during that window; the normal init/login
  // paths replace the defaults as soon as credentials are available.
  int _sdkAppID = 0;
  String _userID = '';
  String _userSig = '';
