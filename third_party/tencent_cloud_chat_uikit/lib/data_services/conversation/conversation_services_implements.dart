...
class ConversationServicesImpl extends ConversationService {
  ...
  Future<V2TimConversation?> getConversationListByConversationId({required String convID}) async {
    final list = await getConversationListByConversationIds(
  ...
  @override
  Future<List<V2TimConversation>> getConversationListByConversationIds({
    required List<String> conversationIDList,
  }) async {
    final ids = conversationIDList
        .map((e) => e.trim())
    ...
    return result.data ?? const <V2TimConversation>[];
  }
