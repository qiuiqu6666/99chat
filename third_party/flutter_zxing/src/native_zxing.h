#if defined(_MSC_VER)
#define NATIVE_ZXING_API __declspec(dllexport)
#else
#define NATIVE_ZXING_API
#endif
...
extern "C"
{
     ...
     * @param enabled
     */
    NATIVE_ZXING_API void setLogEnabled(int enable);
     ...
     */
    NATIVE_ZXING_API char const *version();
     ...
     */
    NATIVE_ZXING_API struct CodeResult readBarcode(char *bytes, int format, int width, int height, int cropWidth, int cropHeight, int tryHarder, int tryRotate, int tryInvert);
     ...
     */
    NATIVE_ZXING_API struct CodeResults readBarcodes(char *bytes, int format, int width, int height, int cropWidth, int cropHeight, int tryHarder, int tryRotate, int tryInvert);
     ...
     */
    NATIVE_ZXING_API struct EncodeResult encodeBarcode(char *contents, int width, int height, int format, int margin, int eccLevel);

    // Private functions
    NATIVE_ZXING_API void resultToCodeResult(struct CodeResult *code, ZXing::Result result);
