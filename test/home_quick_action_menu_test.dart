...
void main() {
  testWidgets('quick menu fits a narrow screen and returns each action',
      (tester) async {
                    ...
                    IconButton(
                        ...
                        onPressed: () async {
                          selected = await showMenu<String>(
                              ...
                              constraints:
                                  const BoxConstraints.tightFor(width: 288),
                              menuPadding:
                                  const EdgeInsets.only(top: 24, bottom: 10),
                              position:
                                  const RelativeRect.fromLTRB(16, 56, 16, 0),
                              items: [
