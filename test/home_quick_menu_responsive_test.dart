        ...
        await tester.pumpWidget(MaterialApp(
          builder: (context, child) => MediaQuery(
              data: MediaQuery.of(context).copyWith(
                  padding: safe, textScaler: TextScaler.linear(textScale)),
              child: child!),
          home: Builder(
              builder: (context) => Scaffold(
                    ...
                    IconButton(
                        ...
                        onPressed: () async {
                          final constraints =
                              homeQuickMenuConstraints(MediaQuery.of(context));
                          selected = await showMenu<String>(
                              ...
                              shape: HomeQuickMenuShape(
                                  arrowX: constraints.maxWidth - 24),
